...
**Project:** Klassico Inks
**Generated:** 2026-09-04 19:44:10
**Category:** B2B Service

---

## Brand Override (source of truth)

The auto-generated B2B palette below recommends navy + blue CTA. **Do not apply that as-is.** Klassico’s flyer brand takes priority:

| Role | Hex | Notes |
|------|-----|-------|
| Brand orange (CTA / accent) | `#D96914` | Existing `primary` token |
| Brand green | `#0A2B10` | Existing `secondary` token |
| Dark surface | `#0f172a` | Current site background |
| Body text on dark | Prefer `#E2E8F0`+ for body; avoid `#94A3B8` for long copy |

Keep the skill’s **structure, accessibility, and checklist** guidance. Override colors/typography with brand tokens above (Inter + Oswald already in use — acceptable industrial pairing; Plus Jakarta Sans is optional if restyling later).
