...
import { Droplet, Package, Check } from 'lucide-react';
...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 pb-20">
      <SEO
        title="Products"
        description="Explore Klassico Inks rotogravure, flexographic, and specialty ink series for flexible packaging, lamination, and surface printing."
        path="/products"
      />
            ...
            {filteredProducts.map((product) => (
              ...
              >
                <Link
                  ...
                  className="block bg-slate-800/50 rounded-2xl border border-slate-700 overflow-hidden hover:border-primary-500/50 transition-colors group h-full"
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold font-heading mb-2 group-hover:text-primary-400 transition-colors">
                      {product.name}
                    </h3>
