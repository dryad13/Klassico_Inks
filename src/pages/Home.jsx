...
import { ArrowRight, CheckCircle, Droplet, Layers, Zap, MessageCircle } from 'lucide-react';
  ...
  return (
    <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        >
          DRIVING{' '}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 via-white to-primary-600">
            INNOVATION
          </span>
          <br />
          IN MANUFACTURING
        ...
        >
          <Link
            to="/products"
            onClick={() => trackEvent('cta_products_click')}
            className="w-full sm:w-auto px-8 py-4 bg-primary-600 hover:bg-primary-500 text-white rounded-lg font-bold transition-all shadow-lg shadow-primary-500/20 flex items-center justify-center gap-2"
          >
            View Products <ArrowRight className="h-5 w-5" />
          </Link>
          <Link
            to="/contact?intent=quote"
            onClick={() => trackEvent('cta_quote_click')}
            className="w-full sm:w-auto px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white rounded-lg font-medium transition-all border border-slate-700"
          >
            Contact Sales
          </Link>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              We combine advanced technology with deep industry expertise to deliver inks that perform perfectly on your substrates.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12 gap-4">
            <div>
              ...
              <p className="text-slate-400 max-w-xl">
                See how packaging printers solve real production challenges with Klassico Inks.
              </p>
            </div>
            <Link
              to="/case-studies"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {caseStudiesData.map((study) => (
              <div
                key={study.id}
                className="bg-slate-800/50 rounded-2xl border border-slate-700 p-6 flex flex-col"
              >
                <span className="text-xs font-bold text-primary-400 uppercase tracking-wider mb-2">
                  {study.industry}
                </span>
                <h3 className="text-lg font-bold font-heading text-white mb-3">{study.title}</h3>
      ...
      <section className="py-20 bg-slate-950 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-slate-400 mb-8 text-lg">
            Join 5,000+ satisfied clients who trust Klassico Inks for their packaging needs.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact?intent=quote"
              onClick={() => trackEvent('cta_quote_click')}
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 text-white rounded-lg font-bold transition-all shadow-xl"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-green-600 hover:bg-green-500 text-white rounded-lg font-medium transition-all"
            >
