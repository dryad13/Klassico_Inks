...
export const productsData = [
  ...
  },
  {
    ...
    substrates: ['PET', 'BOPP'],
    structures: ['PET+BOPP', 'BOPP+MOPP', 'PET+MCPP', 'PET+LDPE'],
    notes: ['High performance lamination', 'PE up to 150µm LDPE', '200 to 400 m/min'],
    tdsUrl: null,
    sdsUrl: null,
  },
  {
    ...
    notes: ['Deep-freeze resistant', 'BOPP corona 38 to 42 dyn/cm'],
    tdsUrl: null,
    sdsUrl: null,
  },
  {
    ...
    notes: [
      ...
      'OPP/LDPE corona 38 to 42 dyn/cm',
      'PET corona 48 to 52 dyn/cm',
    ],
    tdsUrl: null,
    sdsUrl: null,
  },
  ...
  // —— Ink Processes (main category flyer) ——
  {
    ...
    description:
      'Solvent-based rotogravure inks for flexible packaging. Ask sales for grades and TDS.',
    tdsUrl: null,
    sdsUrl: null,
  },
  {
    ...
    category: 'ink-processes',
    description:
      'Solvent-based flexographic inks for packaging print. Ask sales for grades and TDS.',
    tdsUrl: null,
    sdsUrl: null,
  },
  {
    ...
    category: 'ink-processes',
    description:
      'Water-based inks for packaging print. Ask sales for grades and TDS.',
    tdsUrl: null,
    sdsUrl: null,
  },
  {
    ...
    category: 'ink-processes',
    description:
      'Offset inks for commercial and packaging print. Ask sales for grades and TDS.',
    tdsUrl: null,
    sdsUrl: null,
  },
  ...
  // —— Solvents & Blends ——
  {
    ...
    kind: 'chemical',
    category: 'solvents',
    description: 'Industrial solvents and blends for printing ink work.',
  ...
  // —— Printing Ink Industry Products ——
  {
    id: 'pigments',
    slug: 'pigments',
    name: 'Pigments for Ink',
    kind: 'chemical',
    category: 'industry-products',
    description: 'Pigments for printing ink manufacture.',
    items: [
  ...
  },
  {
    ...
    kind: 'chemical',
    category: 'industry-products',
    description: 'Resins used as binders in printing inks.',
    items: [
  ...
  },
  {
    ...
    kind: 'chemical',
    category: 'industry-products',
    description: 'Solvent dye shades for ink formulations.',
